...
ssize_t jl_smallintset_lookup(jl_array_t *cache, smallintset_eq eq, const void *key,
                              jl_svec_t *data, uint_t hv)
{
...
static void smallintset_rehash(jl_array_t **cache, jl_value_t *parent,
                               smallintset_hash hash, jl_svec_t *data, size_t newsz,
                               size_t np);

void jl_smallintset_insert(jl_array_t **cache, jl_value_t *parent, smallintset_hash hash,
