...
template<typename T>
static inline T jl_assume_aligned(T ptr, unsigned align)
{
...
#elif defined(__cplusplus) && defined(__clang_major__) && defined(__clang_minor__) && \
