...
// enable assertions in julia code. After including this file, the definition of `assert`
// will match the setting given in `JL_NDEBUG` and `NDEBUG` will remain unchanged.
//
