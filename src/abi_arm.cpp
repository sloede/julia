...
struct ABI_ARMLayout : AbiLayout {
    bool needPassByRef(jl_datatype_t *dt, AttrBuilder &ab) override { return false; }
...
#define jl_is_floattype(v) jl_subtype(v, (jl_value_t *)jl_floatingpoint_type)
    ...
    Type *get_llvm_fptype(jl_datatype_t *dt) const
    {
        ...
        case 2: lltype = T_float16; break;
        case 4: lltype = T_float32; break;
        case 8: lltype = T_float64; break;
        default: return NULL;
        }
        return ((jl_floatingpoint_type && jl_is_floattype((jl_value_t *)dt)) ? lltype :
                                                                               NULL);
    }
    ...
    //
    // All the out parameters should be default to `false`.
    void classify_arg(jl_datatype_t *dt, bool *reg, bool *onstack, bool *need_rewrite) const
    {
