...
#define CREATE(s)                                                                        \
    ...
    if ((numbits % integerPartWidth) != 0) {                                             \
        /* use LLT_ALIGN to round the memory area up to the nearest integerPart-sized    \
         * chunk */                                                                      \
...
extern "C" JL_DLLEXPORT void LLVMNeg(unsigned numbits, integerPart *pa, integerPart *pr)
{
    APInt z(numbits, 0);
    CREATE(a)
    z -= a;
...
extern "C" JL_DLLEXPORT void LLVMAdd(unsigned numbits, integerPart *pa, integerPart *pb,
                                     integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMSub(unsigned numbits, integerPart *pa, integerPart *pb,
                                     integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMMul(unsigned numbits, integerPart *pa, integerPart *pb,
                                     integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMSDiv(unsigned numbits, integerPart *pa, integerPart *pb,
                                      integerPart *pr)
{
...
extern "C" JL_DLLEXPORT void LLVMUDiv(unsigned numbits, integerPart *pa, integerPart *pb,
                                      integerPart *pr)
{
...
extern "C" JL_DLLEXPORT void LLVMSRem(unsigned numbits, integerPart *pa, integerPart *pb,
                                      integerPart *pr)
{
...
extern "C" JL_DLLEXPORT void LLVMURem(unsigned numbits, integerPart *pa, integerPart *pb,
                                      integerPart *pr)
{
...
extern "C" JL_DLLEXPORT int LLVMICmpEQ(unsigned numbits, integerPart *pa, integerPart *pb)
{
    CREATE(a)
    CREATE(b)
    return a.eq(b);
...
extern "C" JL_DLLEXPORT int LLVMICmpNE(unsigned numbits, integerPart *pa, integerPart *pb)
{
    CREATE(a)
    CREATE(b)
    return a.ne(b);
...
extern "C" JL_DLLEXPORT int LLVMICmpSLT(unsigned numbits, integerPart *pa, integerPart *pb)
{
    CREATE(a)
    CREATE(b)
    return a.slt(b);
...
extern "C" JL_DLLEXPORT int LLVMICmpULT(unsigned numbits, integerPart *pa, integerPart *pb)
{
    CREATE(a)
    CREATE(b)
    return a.ult(b);
...
extern "C" JL_DLLEXPORT int LLVMICmpSLE(unsigned numbits, integerPart *pa, integerPart *pb)
{
    CREATE(a)
    CREATE(b)
    return a.sle(b);
...
extern "C" JL_DLLEXPORT int LLVMICmpULE(unsigned numbits, integerPart *pa, integerPart *pb)
{
    CREATE(a)
    CREATE(b)
    return a.ule(b);
...
extern "C" JL_DLLEXPORT void LLVMAnd(unsigned numbits, integerPart *pa, integerPart *pb,
                                     integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMOr(unsigned numbits, integerPart *pa, integerPart *pb,
                                    integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMXor(unsigned numbits, integerPart *pa, integerPart *pb,
                                     integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMShl(unsigned numbits, integerPart *pa, integerPart *pb,
                                     integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMLShr(unsigned numbits, integerPart *pa, integerPart *pb,
                                      integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT void LLVMAShr(unsigned numbits, integerPart *pa, integerPart *pb,
                                      integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMAdd_uov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMAdd_sov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMSub_uov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMSub_sov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMMul_sov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMMul_uov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMDiv_sov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMDiv_uov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMRem_sov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
extern "C" JL_DLLEXPORT int LLVMRem_uov(unsigned numbits, integerPart *pa, integerPart *pb,
                                        integerPart *pr)
{
    CREATE(a)
    CREATE(b)
...
void LLVMFPtoInt(unsigned numbits, integerPart *pa, unsigned onumbits, integerPart *pr,
                 bool isSigned, bool *isExact)
{
    double Val;
    if (numbits == 32)
        Val = *(float *)pa;
        ...
        jl_error(
            "FPtoSI: runtime floating point intrinsics are not implemented for bit sizes other than 32 and 64");
    ...
    if (onumbits <= 64) { // fast-path, if possible
        ...
        APFloat::opStatus status =
            a.convertToInteger(MutableArrayRef<integerPart>(parts, nbytes), onumbits,
                               isSigned, rounding_mode, &isVeryExact);
                                        ...
                                        unsigned onumbits, integerPart *pr)
{
    ...
    if (onumbits == 32)
        ...
        *(double *)pr = val;
        ...
        jl_error(
            "SItoFP: runtime floating point intrinsics are not implemented for bit sizes other than 32 and 64");
}
                                        ...
                                        unsigned onumbits, integerPart *pr)
{
    ...
    if (onumbits == 32)
        ...
        *(double *)pr = val;
        ...
        jl_error(
            "UItoFP: runtime floating point intrinsics are not implemented for bit sizes other than 32 and 64");
}

extern "C" JL_DLLEXPORT void LLVMSExt(unsigned inumbits, integerPart *pa, unsigned onumbits,
                                      integerPart *pr)
{
...
extern "C" JL_DLLEXPORT void LLVMZExt(unsigned inumbits, integerPart *pa, unsigned onumbits,
                                      integerPart *pr)
{
    if (!(onumbits > inumbits))
...
extern "C" JL_DLLEXPORT void jl_LLVMSMod(unsigned numbits, integerPart *pa, integerPart *pb,
                                         integerPart *pr)
{
    { // end scope before jl_error call
        CREATE(a)
...
extern "C" JL_DLLEXPORT unsigned LLVMCountPopulation(unsigned numbits, integerPart *pa)
{
    CREATE(a)
    return a.countPopulation();
}

extern "C" JL_DLLEXPORT unsigned LLVMCountTrailingOnes(unsigned numbits, integerPart *pa)
{
    CREATE(a)
    return a.countTrailingOnes();
}

extern "C" JL_DLLEXPORT unsigned LLVMCountTrailingZeros(unsigned numbits, integerPart *pa)
{
    CREATE(a)
    return a.countTrailingZeros();
}

extern "C" JL_DLLEXPORT unsigned LLVMCountLeadingOnes(unsigned numbits, integerPart *pa)
{
    CREATE(a)
    return a.countLeadingOnes();
}

extern "C" JL_DLLEXPORT unsigned LLVMCountLeadingZeros(unsigned numbits, integerPart *pa)
{
    CREATE(a)
